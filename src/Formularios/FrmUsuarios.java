...
public class FrmUsuarios extends javax.swing.JFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if(txtNombre.getText().isEmpty() && txtNombre.getText().isEmpty() && txtApellido.getText().isEmpty() && txtUsername.getText().isEmpty() && txtEmail.getText().isEmpty() && txtClave.getText().isEmpty() ){
    ...
    private void btnCargarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCargarActionPerformed
        if(tableUsuarios.getSelectedRow()==-1){
            ...
            txtClave.setText(dtm.getValueAt(tableUsuarios.getSelectedRow(),5).toString());
